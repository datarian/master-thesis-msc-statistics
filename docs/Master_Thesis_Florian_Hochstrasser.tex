...
{\centering \includegraphics[width=0.3\linewidth]{figures/learning/confusion_matrix_model_RF_refit_recall} \includegraphics[width=0.3\linewidth]{figures/learning/confusion_matrix_model_GBM_refit_recall} \includegraphics[width=0.3\linewidth]{figures/learning/confusion_matrix_model_GLMnet_refit_recall} \includegraphics[width=0.3\linewidth]{figures/learning/confusion_matrix_model_NNet_refit_recall} \includegraphics[width=0.3\linewidth]{figures/learning/confusion_matrix_model_SVM_refit_recall} \includegraphics[width=0.3\linewidth]{figures/learning/confusion_matrix_voting_classifier} 
...
{\centering \includegraphics[width=0.7\linewidth]{figures/predictions/y_b_predicted} 
