...
classoption: DIV=12,captions=tableheading,oneside,titlepage=firstiscover,abstracton
...
Over time, different approaches, such as Chi-squared automatic interaction detection and logistic regression were proposed. While in some situations, these alternatives outperformed RFA (see @MCCARTY2007656), RFA remained popular because of it's intuitive interpretation.
